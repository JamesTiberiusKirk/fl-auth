...
docker build -t ghcr.io/jamestiberiuskirk/fl-auth:latest . --build-arg PAT=$PAT
docker push ghcr.io/jamestiberiuskirk/fl-auth:latest # This is disabled in the template